...
Pierwotnie w treningu nie wykorzytane zostały żadne metody
*resmaplingu*.
...
Ewaluacja modeli bez *preprocessingu* i przeszukiwania przestrzeni
hiperparametrów.
...
Dodatkowo tzreba też zadbać o interpretację wartości niezdefiniowanych
...
hiperparametrów.
    ...
    ## ROC was used to select the optimal model using the largest value.
    ## The final values used for the model were nrounds = 500, max_depth = 4, eta = 0.2, gamma = 5, colsample_bytree = 0.5, min_child_weight = 10 and subsample = 0.5.
